export default {
  nav: {
    ...
    applyNow: 'Register / Login',
  },
  vision: {
    pageTitle: 'Vision',
    pageSubtitle: 'Open Survey Agent Hackathon · Hand the night sky to an agent',
    intro:
...
return {"action": "observe", "tile_id": best["tile_id"]}`,
  ...
  - incomplete_priority_penalty`,
    ...
    "reason": "highest useful gain",
      ...
      },
      {
        ...
        paragraphs: [
          'The event has three stages: online training, competition, and awards day. Online training runs September 20–30 and is open worldwide to individuals and teams. The goal is to learn CosmosBench, the shared simulator, mission cards, and the observing-agent interface, and to prepare using public weather scenarios.',
          'The competition runs October 1–17 under one evaluation protocol. Evaluation, submissions, and live standings are powered by CosmosBench and are open to all registered teams. Final results are announced and prizes presented on October 17 at GOSIM Shenzhen.',
        ],
        rounds: [
          { number: '01', name: 'Online Training', dates: 'Sep 20–30', format: 'Online', challenge: 'Learn CosmosBench, the shared simulator, mission cards, and the observing-agent interface, then prepare with public weather scenarios.', participants: 'Open worldwide to individuals and teams.' },
          { number: '02', name: 'Competition', dates: 'Oct 1–17', format: 'Online', challenge: 'Complete the survey task under one evaluation protocol. Evaluation, submissions, and live standings are powered by CosmosBench.', participants: 'All registered teams.' },
  ...
  hero: {
    eyebrow: 'GOSIM Hackathon · Toward agentic survey operations',
    system: 'Open Survey Agent Hackathon',
    subtitle: '巡天开源智能体黑客松',
    lede:
    ...
    pipeline: [
      { label: 'Online Training', date: 'Sep 20–30' },
      { label: 'Competition', date: 'Oct 1–17' },
      { label: 'Awards Day', date: 'Oct 17' },
    ],
    location: ['Online training Sep 20–30 · Competition Oct 1–17', 'October 17 · Awards Day'],
  ...
  home: {
    vision: {
      ...
      link: 'Read the full vision document',
      stats: [
    ...
    participate: {
      ...
      timeline: [
        { label: 'Sep 20–30', desc: 'Online training' },
        { label: 'Oct 1–17', desc: 'Competition' },
        { label: 'Oct 17', desc: 'Awards at GOSIM Shenzhen' },
      ],
      cta: 'Register now',
    },
    leaderboard: {
      kicker: '04 / Leaderboard',
...
return {"action": "observe", "tile_id": best["tile_id"]}`,
  ...
  footer: {
    copyright: '2026 GOSIM Open Survey Agent Hackathon · 巡天开源智能体黑客松',
    mainSite: 'GOSIM',
