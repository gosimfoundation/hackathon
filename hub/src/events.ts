    ...
    hackathons: [
      {
        ...
        descriptionZh: '通过线上资格赛与 GOSIM Shenzhen 现场终场，构建并评测达到生产级水平的智能体 Harness。',
      ...
      },
      {
        ...
        formatZh: '线上培训 + GOSIM Shenzhen 线上及现场混合决赛',
        status: 'upcoming',
        href: '/survey26/',
      },
      {
        ...
        description: 'Build open-source Agentic mini apps with OctoSense and robrix2 to automate everyday tasks across email, messaging, and calendars.',
        descriptionZh: '基于 OctoSense 与 robrix2，围绕邮件、即时消息和日历等日常场景，构建开源 Agentic 小程序。',
