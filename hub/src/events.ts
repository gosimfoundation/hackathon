    ...
    hackathons: [
      {
        ...
        description: 'Build Agentic apps around OctoSense scenarios such as mail, messaging and calendar. Messaging uses robrix2, with hagency for software collaboration. Compete on task automation and advance through ecosystem and ROM contributions. Kickoff September 22; classes from September 26 on weekends and during the National Day holiday. Apache 2.0 submissions; RMB 50,000 in cash and MiniMax token credits.',
        descriptionZh: '以 OctoSense 为核心，围绕邮件、即时消息、日历等场景构建 Agentic 应用；即时消息绑定 robrix2，软件协作可接入 hagency。先比任务自动化，再以生态贡献和 ROM 突破进阶。9/22 开营，9/26 起周末与国庆集中上课。作品以 Apache 2.0 开源提交，获奖奖池 ¥50,000（含现金奖金与 MiniMax Token 额度）。',
