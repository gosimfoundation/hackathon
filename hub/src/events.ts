    ...
    hackathons: [
      {
        ...
        name: 'Agentic App Hackathon — The Task Is the App',
        nameZh: 'Agentic App 黑客松 · 意图所至，应用而生',
        description: 'Turn a real intent into a working app with OctoSense. One challenge, three optional depths, and equal recognition for intent design and technical breakthroughs.',
        descriptionZh: '围绕 OctoSense，把真实意图变成能用的应用。一条主赛道、三级自选深度，意图设计与技术突破双线平等评奖。',
