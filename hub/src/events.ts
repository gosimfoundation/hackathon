    ...
    hackathons: [
      {
        ...
        description: 'Build intent-driven apps with OctoSense + AppCard, or software factory mini apps with robrix2 + hagency. Two tracks, three depths from Nautilus to Giant Octopus on an open, pure-Rust agentic stack, Apache 2.0 submissions and a ¥40,000 prize pool.',
        descriptionZh: '用 OctoSense + AppCard 构建意图应用，或用 robrix2 + hagency 为软件工厂增加小程序。两大赛道，鹦鹉螺、帝王蟹、大章鱼三级深度，基于纯 Rust 开源 Agentic 技术栈，作品以 Apache 2.0 开源提交，总奖金池 ¥40,000。',
