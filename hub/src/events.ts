    ...
    hackathons: [
      {
        ...
        description: 'Build intent-driven apps with OctoSense + AppCard, or software factory mini apps with robrix2 + hagency. Two tracks, three optional depths, and shared awards for design and technical breakthroughs.',
        descriptionZh: '用 OctoSense + AppCard 构建意图应用，或用 robrix2 + hagency 为软件工厂增加小程序。两大赛道、三级自选深度，意图设计与技术突破双线平等评奖。',
