    ...
    hackathons: [
      {
        ...
        description: 'Build agent-native apps on an open, pure-Rust agentic stack: Octos, Octoscript, Makepad and OctoSense. Pick a system app, make it agent-native, and dive from Nautilus to Giant Octopus. Submissions are Apache 2.0 open source.',
        descriptionZh: '在 Octos、Octoscript、Makepad 与 OctoSense 这条纯 Rust 开源 Agentic 技术栈上，挑一个系统应用把它 Agent 化。鹦鹉螺、帝王蟹、大章鱼三级深度，作品以 Apache 2.0 开源提交。',
        dates: 'Sep – Oct 2026 · Registration open',
        datesZh: '2026 年 9–10 月 · 报名进行中',
        format: 'Online rounds + live showcase at GOSIM Shenzhen 2026 · ¥40,000 prize pool',
        formatZh: '线上初赛与决赛 + GOSIM Shenzhen 2026 现场展示 · 总奖金池 ¥40,000',
        status: 'open',
        href: '/agenticapp26/',
      },
      {
