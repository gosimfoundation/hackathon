    ...
    hackathons: [
      {
        ...
        description: 'Build intent-driven apps with OctoSense + AppCard, or software factory mini apps with robrix2 + hagency. Two tracks, three depths from Nautilus to Giant Octopus on an open, pure-Rust agentic stack, Apache 2.0 submissions and a RMB 50,000 prize pool including cash and MiniMax token credits.',
        descriptionZh: '用 OctoSense + AppCard 构建意图应用，或用 robrix2 + hagency 为软件工厂增加小程序。两大赛道，鹦鹉螺、帝王蟹、大章鱼三级深度，基于纯 Rust 开源 Agentic 技术栈，作品以 Apache 2.0 开源提交，获奖奖池 ¥50,000（含现金奖金与 MiniMax Token 额度）。',
        dates: 'September 13–October 17, 2026',
        datesZh: '2026 年 9 月 13 日–10 月 17 日',
        format: 'Online qualifying: 50 participants advance → award round: First, Second & Third Prizes → October 17 project showcase & awards ceremony at the GOSIM Hackathon for the top three teams',
        formatZh: '初赛海选晋级 50 人 → 复赛评出一、二、三等奖 → 前三名 10 月 17 日到 GOSIM 黑客松现场展示作品并参加颁奖',
        status: 'upcoming',
        href: '/agenticapp26/',
      },
      {
