    ...
    hackathons: [
      {
        ...
        format: 'Online qualifying: 50 participants advance → award round: First, Second & Third Prizes → October 17 showcase for the top 2–3 teams',
        formatZh: '初赛海选晋级 50 人 → 复赛评出一、二、三等奖 → 前 2–3 名 10 月 17 日 GOSIM 现场展示',
        status: 'upcoming',
        href: '/agenticapp26/',
      },
      {
